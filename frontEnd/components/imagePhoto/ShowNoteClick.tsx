...
const ShowNoteClick = ({ visible, onClose, allValueShow }) => {
    ...
    const handleColorChange = (selectedColor: React.SetStateAction<string>) => {
    ...
    const handleDeleteNoteAction = (id: any) => {
        if (isConnected) {
            handleDeleteNote({id});
            onClose();
            setShowColorPalette(false);
                    ...
                    <View style={styles.modal}>
                        ...
                        {timeDateVisible && (
                            <DateTimeComponent
                                ...
                                date={date}
                                setDate={setDate}
                                setTimeDateVisible={setTimeDateVisible} visible={undefined} onClose={undefined}                            />
                        )}
