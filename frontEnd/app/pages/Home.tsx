...
import {View, TextInput, Image, StyleSheet, TouchableOpacity, Animated,Text} from 'react-native';
...
const Home = () => {
    ...
    function handleValueClick(id: any, title: string, content: string, color: any, image: any, date: any, photoUri: any) {
